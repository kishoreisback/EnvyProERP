...
import { Lead, LeadForm, LeadStatus, LeadPriority } from "./types";
...
export function EditLead({ lead, onSubmit, onClose }: EditLeadProps) {
  ...
  return (
    <>
      <DialogHeader>
        ...
        <DialogDescription>
          Update lead information and sales pipeline details
        </DialogDescription>
      </DialogHeader>
          ...
          <Tabs defaultValue="basic" className="space-y-4">
            ...
            <TabsContent value="tracking" className="space-y-6">
              ...
              <div className="border-t pt-4">
                <h4 className="font-medium mb-2">Lead Analytics (Read-only)</h4>
                <div className="grid gap-4 md:grid-cols-3">
